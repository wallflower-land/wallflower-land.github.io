...
<svg {...rest} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	<defs>
		<linearGradient id={`star-gradient-${id}`} x1="0%" x2="100%" y1="0%" y2="0%">
			<stop offset="0%" stop-color={fill} />
			<stop offset={`${Math.floor(100 * fillPercent)}%`} stop-color={fill} />
			<stop offset={`${Math.floor(100 * (fillPercent + 0.01))}%`} stop-color={fillEnd} />
