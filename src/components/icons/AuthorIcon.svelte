...
<svg viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill={stroke} {...rest}>
	...
	<g id="SVGRepo_iconCarrier">
		...
		></path>
		<path class="cls-1" style:stroke d="M19.64,6.27H22.5V22.5H12V10.09a3.82,3.82,0,0,1,3.82-3.82"></path>
		<path
			class="cls-1"
			style:stroke
